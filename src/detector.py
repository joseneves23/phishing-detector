...
class PhishingDetector:
    ...
    def predict(self, url):
        ...
        try:
            ...
            score = self.model.predict_proba(X)[0][1]  # Probabilidade da classe positiva
        ...
        top_indicators = self._get_top_indicators(features, url)
    ...
    def _heuristic_prediction(self, features):
        ...
        suspicious_criteria = [
            ...
            features.get('domain_match', 1) == 0 and features.get('has_ssl', 0) == 1,
    ...
    def _get_top_indicators(self, features, url):
        ...
        if features.get('domain_age_days', 365) < 30 and features.get('domain_age_days', -1) > 0:
            indicators.append(f"Domínio registrado recentemente ({features.get('domain_age_days')} dias)")
        ...
        if features.get('has_ssl', 1) == 0:
            ...
            indicators.append("Certificado SSL não emitido por autoridade confiável")
